// The original progress screen from before the Phase 4 dashboard, kept as an
// alternative view: pick a workout, then per-exercise top-weight charts with
// 1W/1M/3M/All ranges and the gold personal-best line. Restored verbatim.
...
export default function LegacyDashboard({ data, lang, themeId, th, todayStr }) {
